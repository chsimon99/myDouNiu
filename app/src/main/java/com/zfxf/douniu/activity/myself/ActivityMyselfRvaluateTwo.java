...
public class ActivityMyselfRvaluateTwo extends FragmentActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_myself_rvaluate_second);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.rl_myself_rvaluate_confirm:
                ...
                Intent intent = new Intent(this,ActivityMyselfRvaluateThird.class);
