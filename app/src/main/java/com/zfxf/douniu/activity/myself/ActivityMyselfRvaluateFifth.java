...
public class ActivityMyselfRvaluateFifth extends FragmentActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_myself_rvaluate_fifth);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.rl_myself_rvaluate_confirm:
                ...
                result = result+num;
                Intent intent = new Intent(this,ActivityMyselfRvaluateSix.class);
