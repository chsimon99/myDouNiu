package com.zfxf.douniu.bean.address;
...
import com.zfxf.douniu.bean.address.wheel.OnWheelChangedListener;
import com.zfxf.douniu.bean.address.wheel.OnWheelClickedListener;
import com.zfxf.douniu.bean.address.wheel.WheelView;
import com.zfxf.douniu.bean.address.wheel.adapter.AbstractWheelTextAdapter;
...
//		getWindow().setWindowAnimations(R.style.AnimBottom);
		View rootView = getLayoutInflater().inflate(
				R.layout.wheel_dialog_city_picker, null);
