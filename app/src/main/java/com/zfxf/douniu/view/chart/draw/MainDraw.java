...
//        if(position == 1){
//            Log.d("----11--","curPoint="+curPoint.getClosePrice());
//            Log.d("----11--","lastX="+lastX);
//            Log.d("----11--","curX="+curX);
//            Log.d("----11--","lastPoint="+lastPoint.getClosePrice());
//        }
//        view.drawMainLine(canvas, ma5Paint, lastX, lastPoint.getOpenPrice(), curX, curPoint.getOpenPrice());
    ...
    @Override
    public float getMaxPrice(CandleImpl point) {
        return point.getHighPrice();
    }
    @Override
    public float getMinPrice(CandleImpl point) {
