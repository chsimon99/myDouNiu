...
public class FragmentAdvisorShouxi extends BaseFragment {
	...
	public FragmentAdvisorShouxi(int type) {
		this.type = type;
	}
	@Override
	...
	private void visitInternet() {
		NewsInternetRequest.getAdvisorListInformation(type, currentPage,new NewsInternetRequest.ForResultAdvisorSXListener() {
			@Override
