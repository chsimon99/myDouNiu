...
//        });
    ...
    private void visitInternet() {
        NewsInternetRequest.getStockKLineInformation(getActivity().getIntent().getStringExtra("code"), currentPage, "0", new NewsInternetRequest.ForResultStockKLineInfoListener() {
            @Override
