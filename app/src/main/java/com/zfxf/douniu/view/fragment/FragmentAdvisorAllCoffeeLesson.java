...
public class FragmentAdvisorAllCoffeeLesson extends BaseFragment {
    private View view;

    @BindView(R.id.tl_advisor_home_coffee)
    TabLayout mTabLayout;
    @BindView(R.id.vp_advisor_home_coffee)
    ...
    public View initView(LayoutInflater inflater) {
        if (view == null) {
            view = inflater.inflate(R.layout.fragment_advisor_home_coffee, null);
        }
    ...
    public void initdata() {
        ...
        if(list_title.size() == 0){
            String[] titleStrings = CommonUtils.getResource().getStringArray(R.array.advisor_home_coffee_titles);
