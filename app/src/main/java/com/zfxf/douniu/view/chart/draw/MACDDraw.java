...
//        view.drawChildLine(canvas, ma20Paint, lastX, lastPoint.getMacd(), curX, curPoint.getMacd());
    }
    ...
    @Override
    public float getMaxPrice(MACDImpl point) {
        return 0;
    }

    @Override
    public float getMinPrice(MACDImpl point) {
        return 0;
    }
