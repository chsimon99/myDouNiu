 ...
 */
public class MyViewPagerSimulation extends ViewGroup {
    ...
    public MyViewPagerSimulation(Context context) {
        super(context);
        initViewPager();
    }

    public MyViewPagerSimulation(Context context, AttributeSet attrs) {
        super(context, attrs);
        initViewPager();
    }
