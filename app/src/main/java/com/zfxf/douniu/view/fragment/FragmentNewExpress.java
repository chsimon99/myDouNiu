...
public class FragmentNewExpress extends BaseFragment {
	...
	private void visitInternet(){
		NewsInterRequestUtils.getNewsExpressInformation(currentPage+"", "20", "false", new NewsInterRequestUtils.ForNewsExpressInfoListener() {
			@Override
			public void onResponseMessage(List<Map<String, String>> lists, String totalpage) {
				...
				if (totlePage > 0 && currentPage <= totlePage){
					if(currentPage == 1){
						...
						map.put("top","top");
						mExpressAdapter.addTopDatas(map);
					}else {
