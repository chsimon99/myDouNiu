...
public class MyselfConsumeDoneAdapter extends RecyclerView.Adapter<MyselfConsumeDoneAdapter.MyHolder> {
    ...
    public MyselfConsumeDoneAdapter(Context context, List<PayOrderInfo> datas) {
        mContext = context;
        mDatas = datas;
    }
    ...
    public MyHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = View.inflate(mContext, R.layout.item_myself_consume_done,null);
